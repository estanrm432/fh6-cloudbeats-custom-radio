...
Config load_config(const std::filesystem::path& path) {
    ...
    cfg.playback.show_track_notification =
        pick<bool>(pb, "show_track_notification", cfg.playback.show_track_notification);
    try {
...
void save_config(const std::filesystem::path& path, const Config& cfg) {
    ...
    e.kv("show_track_notification", cfg.playback.show_track_notification);
